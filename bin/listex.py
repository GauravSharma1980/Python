...
print("Value at index 2 : ", my_list_1[3]) # Java
print("2nd  character of Value at index 2 : ", my_list_1[3][2]) # 'v'



print("Value at index 2 : ", my_list_1[4]) # Java
print("2nd  character of Value at index 2 : ", my_list_1[4][0]) # '100'
