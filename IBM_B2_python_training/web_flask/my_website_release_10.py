...
# ----------------------
# END POINT - 9 : URL http://127.0.0.1:5000/getweatherdetails mapped to '/getweatherdetails'
# ----------------------
@my_website_app.route('/getweatherdetails', methods=['POST'])
def my_getweatherdetails_page():
    """
    Tasks
    1. Get city name from front end
    2. Add city name to weather api
    3. call api and get weather details
    4. send weather details to html page
    """
    ...
    # 2. Add city name to weather api
    # --------------------------------
    weather_api = f'https://demoqa.com/utilities/weather/city/{city_name}'
    # --------------------------------
    ...
    # we have data in dictionary
    # --------------------------------

    # --------------------------------
    # 4. send weather details to html page
    # --------------------------------
    return flask.render_template('apiresults.html', my_weather_data = weather_api_response)
    # --------------------------------
