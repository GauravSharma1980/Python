"""
Requirement: Write a function for log process,
if we pass log file path then it should return extracted info
"""


def log_process_func_positional(log_file_path):
    """
...
func_1_result = log_process_func_positional("../log/server_log.txt")
print("func_1_result : ", func_1_result)
func_2_result = log_process_func_keyword(log_file_path="../log/server_log.txt")
