...
print("# Task - 4 : Create the insert query ")
print("#"*20)
##############################

insert_query = ''' insert into MY_LOG_DATA_TABLE values(
                    '{ip}',
                    '{dt}',
                    '{img}',
                    '{url}'
...
for each_line in list_of_lines:
    ...
    if match_result is not None:
        ...
        insert_query = f''' insert into MY_LOG_DATA_TABLE values(
                    '{ip}',
                    '{dt}',
                    '{img}',
                    '{url}'
                ...
                '''
        my_db_cursor.execute(insert_query)
        print(ip, dt,img, url)
